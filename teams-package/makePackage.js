...
fs.readFile(dir, 'utf8', function (err, data) {
    ...
    fs.writeFile('teams-package/manifest.json', data, 'utf-8', (err, data) => {
        ...
        zip.addLocalFile(`teams-package/icon192.png`);

        zip.writeZip(`teams-package/cookiemonster-teams-app.zip`);
        console.log(`Created app package teams-package/cookiemonster-teams-app.zip`);
    });
});